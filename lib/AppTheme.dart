...
class AppTheme {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    navigationRailTheme: NavigationRailThemeData(
        selectedIconTheme:
            IconThemeData(color: Color(0xff15cb95), opacity: 1, size: 24),
        unselectedIconTheme:
            IconThemeData(color: Color(0xff495057), opacity: 1, size: 24),
        backgroundColor: Color(0xffffffff),
        elevation: 3,
        selectedLabelTextStyle: TextStyle(color: Color(0xff15cb95)),
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      focusedBorder: OutlineInputBorder(
        ...
        borderSide: BorderSide(width: 1, color: Color(0xff15cb95)),
      ),
    ...
    floatingActionButtonTheme: FloatingActionButtonThemeData(
        ...
        elevation: 4,
        focusColor: Color(0xff15cb95),
        hoverColor: Color(0xff15cb95),
        foregroundColor: Colors.white),
    dividerColor: Color(0xffd1d1d1),
    errorColor: Color(0xfff0323c),
    cardColor: Colors.white,
    //accentColor: Color(0xff15cb95),
    ...
    tabBarTheme: TabBarTheme(
      ...
      indicator: UnderlineTabIndicator(
        borderSide: BorderSide(color: Color(0xff15cb95), width: 2.0),
      ),
    ),
    sliderTheme: SliderThemeData(
      activeTrackColor: Color(0xff15cb95),
      inactiveTrackColor: Color(0xff15cb95).withAlpha(140),
      trackShape: RoundedRectSliderTrackShape(),
      trackHeight: 4.0,
      thumbColor: Color(0xff15cb95),
  ...
  static ThemeData darkTheme = ThemeData(
      ...
      colorScheme: ColorScheme.dark(
        primary: Color(0xff15cb95),
       // primaryVariant: Color(0xff15cb95),
      ...
      sliderTheme: SliderThemeData(
        activeTrackColor: Color(0xff15cb95),
        inactiveTrackColor: Color(0xff15cb95).withAlpha(100),
        trackShape: RoundedRectSliderTrackShape(),
        trackHeight: 4.0,
        thumbColor: Color(0xff15cb95),
        thumbShape: RoundSliderThumbShape(enabledThumbRadius: 10.0),
  ...
  static NavigationBarTheme getNavigationThemeFromMode(int themeMode) {
    ...
    if (themeMode == themeLight) {
      ...
      navigationBarTheme.selectedItemColor = Color(0xff15cb95);
      navigationBarTheme.unselectedItemColor = Color(0xff495057);
      navigationBarTheme.selectedOverlayColor = Color(0x3815cb95);
    } else if (themeMode == themeDark) {
