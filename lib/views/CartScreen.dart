...
import 'package:EMallApp/models/CustomCart.dart';
...
import 'package:EMallApp/views/checkout/CheckoutOrderScreen.dart';
...
class CartScreen extends StatefulWidget {
  ...
  CartScreen({required this.subcategories,required this.category});
  @override
...
class _CartScreenState extends State<CartScreen> {
 ...
 int quantity=1;
  ...
  void _checkoutCart(SubCategory sub) async {
