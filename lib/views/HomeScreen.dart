...
import 'package:EMallApp/views/SubCategoryScreen.dart';
...
import 'deliveryto/deliveryto_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  _getSubCategories(int ?id,Category category) async {
    if (mounted) {
      setState(() {
        isInProgress = true;
      });
    ...
    await CategoryController.getCategorySubCategories(id!);
                                ...
                                children: [
                                 ...
                                 account==null ? Container():  Divider(height: 23,thickness: 1.2,),
                                  ...
                                  ListTile(
                                   ...
                                   account==null ? Container():  SizedBox(height: 10,),
        ...
        children: [
          Container(
           ...
           account==null ? Container() :   _addressWidget(),
            account==null ? Container() :   _bannersWidget(),
                Categories(),
                      ...
                      list.add(PopupMenuItem(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              userAddresses![i].type.toString()=='0'?
                              Text('home',
                                  style: AppTheme.getTextStyle(
                                    themeData.textTheme.bodyText2,
                                    fontWeight: 600,
                                    color: themeData.colorScheme.onBackground,
                                  )):userAddresses![i].type.toString()=='1'?
                              Text('work',
                                  style: AppTheme.getTextStyle(
                                    themeData.textTheme.bodyText2,
                                    fontWeight: 600,
            ...
            itemBuilder: (BuildContext context,int index){
              return GestureDetector(
                  onTap: (){
                    ...
                    setState(() {
                      // _getMainCategories();
                    pushScreen(context, SubCategoryScreen(category: category[index],id: category![index].id ,));
                     //  pushScreen(context, DeliveryTo());
                      // supcatigo = category![index].id;
                      // _getSubCategories(category![index].id,category![index]);
                      // _refresh();
                    });
                  },
